  ...
  const chartData =
    viewMode === "daily"
      ...
      : data.hourlyStats.map((s) => ({
          label: new Date(s.time).toLocaleTimeString(undefined, {
            hour: "2-digit",
            hour12: false,
          }),
          value: s.count,
        ...
        <main className="mx-auto max-w-5xl">
          <header className="mb-16">
            <div className="flex items-baseline gap-4">
              <h1 className="font-display text-4xl font-bold tracking-tight text-zinc-400">
                /{slug}
              </h1>
            </div>
            <div className="mt-8">
