...
### Google OAuth Login
*   **Method**: `GET`
*   **URL**: `https://app.scg.io/api/v1/auth/google`
...
### Get User Info
*   **Method**: `GET`
*   **URL**: `https://app.scg.io/api/v1/user`
...
### Create Short URL
*   **Method**: `POST`
*   **URL**: `https://app.scg.io/api/v1/urls`
...
### Update URL
*   **Method**: `PATCH`
*   **URL**: `https://app.scg.io/api/v1/urls/{urlId}`
...
{
  "urlId": 123,
  "shortenedUrl": "https://scg.io/new-slug",
...
### Get Statistics
*   **Method**: `GET`
*   **URL**: `https://app.scg.io/api/v1/urls/{slug}/analytics`
...
```json
{
  "totalClicks": 150,
  "hourlyStats": [
    { "time": "2024-05-20T14:00:00", "count": 5 }
  ],
  "dailyStats": [
...
*   **Method**: `GET`
*   **URL**: `https://scg.io/`
*   **Description**: 301 Redirect to the main app (app.scg.io).
*   **Access**: Public

**Response**
*   **Status**: `301 Permanently redirect`
*   **Header**: `Location: https://app.scg.io`
